...
function Services() {
  return (
    <>
        ...
        <div className=' my-4 flex md:flex-row gap-36 flex-wrap justify-center poppins'>
            ...
            <div className=' rounded-md p-4'>
                ...
                <div className='flex text-lg flex-col gap-2 font-semibold text-slate-100  *:min-w-40 *:bg-sky-400 *:rounded-tr-lg *:rounded-tl-lg *:p-1 *:shadow-md *shadow-gray-200'>
